...
public class CoreItem extends CustomItem {
    ...
    private void attachIdentifier() {
        ...
        meta.getPersistentDataContainer().set(PrimaxLib.inst().getIdentifierKey(), PersistentDataType.STRING, key);
    ...
    private boolean isIdentified(ItemStack item, boolean ignoreAmount) {
        ...
        String key = meta.getPersistentDataContainer().get(PrimaxLib.inst().getIdentifierKey(), PersistentDataType.STRING);
