package net.primaxstudios.primaxcore.currency;

import dev.dejvokep.boostedyaml.block.implementation.Section;
import lombok.Getter;
import net.primaxstudios.primaxcore.currency.type.CoinsEngineCurrency;
import net.primaxstudios.primaxcore.currency.type.CustomCurrency;
import net.primaxstudios.primaxcore.currency.type.PlayerPointsCurrency;
import net.primaxstudios.primaxcore.currency.type.VaultCurrency;
