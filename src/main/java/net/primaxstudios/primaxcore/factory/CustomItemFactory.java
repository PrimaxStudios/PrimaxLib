...
import net.primaxstudios.primaxcore.item.CoreItem;
import net.primaxstudios.primaxcore.item.CustomItem;
import net.primaxstudios.primaxcore.item.DataItem;
import net.primaxstudios.primaxcore.item.property.ItemPropertyType;
...
public final class CustomItemFactory {
    ...
    public static String getKey(ItemStack item) {
        ...
        return item.getItemMeta().getPersistentDataContainer()
                .get(PrimaxCore.inst().getIdentifierKey(), org.bukkit.persistence.PersistentDataType.STRING);
    }
}
