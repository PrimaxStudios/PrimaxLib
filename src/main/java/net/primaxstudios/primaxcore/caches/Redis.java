package net.primaxstudios.primaxcore.caches;

import lombok.Getter;
import net.primaxstudios.primaxcore.caches.processors.JedisExecutor;
import net.primaxstudios.primaxcore.caches.processors.JedisQuery;
...
public class Redis {
    ...
    public Redis(String host, int port, String password, boolean useSSL) {
        this.host = host;
        this.port = port;
